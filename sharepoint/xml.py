...
namespaces = {
    ...
    'sps': 'http://schemas.microsoft.com/sharepoint/soap/',
    ...
    'sp': 'https://github.com/ox-it/python-sharepoint/',
}
...
SP = builder.ElementMaker(namespace=namespaces['sps'], nsmap=namespaces)
...
OUT = builder.ElementMaker(namespace=namespaces['sp'], nsmap=namespaces)
